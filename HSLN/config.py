...
class Config():
    def __init__(self, parser, load=True):
        ...
        parser.add_argument('--filename_wordvec', default='word2vec_final.txt', 
        ...
        self.filename_wordvec = os.path.join('/projects/F202600026AIVLABDEUCALION/helenice/word2vec-deucalion', 
